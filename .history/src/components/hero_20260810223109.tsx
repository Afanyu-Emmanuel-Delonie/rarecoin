  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(51,85,255,0.07) 0%, rgba(123,63,228,0.04) 50%, transparent 100%)",
        }}
      />
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(51,85,255,0.08) 0%, transparent 68%)" }}
      />
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(123,63,228,0.06) 0%, transparent 68%)" }}
      />
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-col items-center gap-7 px-6 py-28 text-center md:py-36 lg:px-16">
        ...
        <h1 className="font-heading text-5xl font-bold leading-[1.05] tracking-tight text-[#0b0c12] md:text-6xl lg:text-7xl">
          ...
          <span className="hero-word block bg-gradient-to-r from-[#3355ff] to-[#7b3fe4] bg-clip-text text-transparent">
            Shape the Future.
          </span>
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Link
            href="/docs"
            className="hero-cta group inline-flex items-center gap-2 rounded-full bg-[#0f3f93] px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-[#0f3f93] hover:gap-3"
          >
            Read White Paper
