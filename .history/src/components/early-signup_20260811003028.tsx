  ...
  return (
    <section className="bg-[#F4F6FB] px-6 py-20 lg:px-16">
      <div className="mx-auto max-w-7xl">
        <div
          className="relative overflow-hidden rounded-3xl bg-[#0f3f93] px-10 py-16 md:px-20"
          data-reveal
        >
          {/* Ambient blobs */}
          <div
            className="pointer-events-none absolute left-0 top-0 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full"
            style={{ background: "radial-gradient(circle, rgba(255,255,255,0.08) 0%, transparent 70%)" }}
          />
          <div
            className="pointer-events-none absolute bottom-0 right-0 h-72 w-72 translate-x-1/2 translate-y-1/2 rounded-full"
