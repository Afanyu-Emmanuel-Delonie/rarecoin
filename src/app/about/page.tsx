    ...
    <div ref={pageRef} className="pt-20 bg-[#08090D]">
      ...
      <div className="mx-auto max-w-7xl px-6 py-28 lg:px-16">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="about-block relative flex flex-col gap-5 overflow-hidden rounded-3xl bg-[#111318] border border-white/6 p-10" data-scale>
            <div className="pointer-events-none absolute -bottom-12 -right-12 h-56 w-56 text-[#D4AF37] opacity-[0.05]">
              <GhostCircles className="h-full w-full" />
            </div>
            <div className="relative flex h-11 w-11 items-center justify-center rounded-2xl bg-[#D4AF37]/10">
              <Eye size={20} className="text-[#D4AF37]" strokeWidth={1.75} />
            </div>
            <div className="relative flex flex-col gap-2">
              <span className="text-xs font-semibold uppercase tracking-widest text-[#D4AF37]">Vision</span>
              <h2 className="font-heading text-2xl font-bold text-white">The most genuinely community-owned digital asset in its category.</h2>
            </div>
          ...
          <div className="about-block relative flex flex-col gap-5 overflow-hidden rounded-3xl bg-[#D4AF37] p-10" data-scale>
            <div className="pointer-events-none absolute -bottom-12 -right-12 h-56 w-56 text-[#08090D] opacity-[0.08]">
              <GhostFlower className="h-full w-full" />
            </div>
            <div className="relative flex h-11 w-11 items-center justify-center rounded-2xl bg-[#08090D]/15">
              <Target size={20} className="text-[#08090D]" strokeWidth={1.75} />
            </div>
            <div className="relative flex flex-col gap-2">
              <span className="text-xs font-semibold uppercase tracking-widest text-[#08090D]/60">Mission</span>
              <h2 className="font-heading text-2xl font-bold text-[#08090D]">Prove that a fair-launch token can deliver real, disclosed utility.</h2>
            </div>
            <p className="relative text-sm leading-relaxed text-[#08090D]/65">
      ...
      <div className="relative overflow-hidden bg-[#111318] px-6 py-28 lg:px-16">
        ...
        <div className="relative mx-auto max-w-7xl flex flex-col gap-16">
          <div className="flex flex-col gap-3">
            <span className="text-xs font-semibold uppercase tracking-widest text-[#D4AF37]">Core Values</span>
            <h2 className="font-heading text-4xl font-bold text-white md:text-5xl">What we stand for.</h2>
          </div>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {values.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="about-value flex flex-col gap-4 rounded-2xl border border-white/6 bg-white/3 p-7">
      ...
      <div className="mx-auto max-w-7xl px-6 py-28 lg:px-16">
        <div className="flex flex-col gap-16">
          <div className="flex flex-col gap-3">
            <span className="text-xs font-semibold uppercase tracking-widest text-[#D4AF37]">Why RARE</span>
            <h2 className="font-heading text-4xl font-bold text-white md:text-5xl">Three reasons this is different.</h2>
          </div>
